	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">家属账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.jiashuzhanghao" 
						 placeholder="请输入家属账号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">家属姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.jiashuxingming" 
						 placeholder="请输入家属姓名"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.jiashuzhanghao)){
		...
		if((!registerForm.value.jiashuxingming)){
