				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="家属账号" prop="jiashuzhanghao">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.jiashuzhanghao?true:false"
								v-model="form.jiashuzhanghao" 
								placeholder="请选择家属账号"
								>
								<el-option v-for="(item,index) in jiashuzhanghaoLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			...
			jiashuzhanghaoLists.value = res.data.data
		})
	}
	//初始化
	//声明父级调用
