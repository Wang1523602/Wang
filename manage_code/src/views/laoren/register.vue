			...
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					...
					<el-select 
						...
						placeholder="请选择家属账号"
						>
						<el-option v-for="item in laorenjiashuzhanghaoLists" :label="item" :value="item"></el-option>
					</el-select>
				</div>
...
<script setup>
	...
	const laorenjiashuzhanghaoLists = ref([])
	const init=()=>{
		laorenxingbieLists.value = "男,女".split(',')
		context?.$http({
			url:`option/laorenjiashu/jiashuzhanghao`,
			method:'get'
		}).then(res=>{
			laorenjiashuzhanghaoLists.value = res.data.data
		})
	}
